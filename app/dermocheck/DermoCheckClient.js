...
export default function DermoCheckClient() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: 'DermoCheck PRO - Calculadora Batch Code',
      text: 'Calcula el vencimiento exacto de tus productos dermocosméticos leyendo el Batch Code en AuxiliarPro.',
  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans pb-24">
      ...
      <header className="bg-[#0f172a] text-white pt-12 pb-20 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-medium">
            La <strong className="text-white font-black">calculadora de vencimiento</strong> definitiva para la farmacia. Ingresa el <span className="text-emerald-400 font-bold">Batch Code</span> y descubre la fecha de caducidad exacta de marcas como Eucerin, La Roche-Posay, Vichy y CeraVe.
          </p>
        </div>
      </header>
      ...
      <div className="max-w-3xl mx-auto px-6 -mt-12 space-y-12">
        ...
        <section className="relative">
          <form onSubmit={handleCalculate} className="bg-white rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 overflow-hidden">
            <div className="bg-[#1e293b] p-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-black text-white uppercase text-sm tracking-widest">Calculadora de Lotes</h2>
              </div>
            ...
            <div className="p-8 md:p-12 space-y-8">
              <div>
                <label className="text-sm font-black text-slate-700 bg-slate-100 py-1.5 px-4 rounded-lg inline-block shadow-sm border border-slate-200 uppercase tracking-wider mb-4">
                  1. Selecciona Marca Dermocosmética
                </label>
              ...
              <div>
                <label className="text-sm font-black text-slate-700 bg-slate-100 py-1.5 px-4 rounded-lg inline-block shadow-sm border border-slate-200 uppercase tracking-wider mb-4">
                  2. Ingresa Código de Lote (Batch Code)
                </label>
                <input 
                  type="text"
                  value={code}
          ...
          {result && (
            <div className="mt-8 bg-emerald-500 rounded-[2.5rem] p-10 shadow-2xl text-white animate-in slide-in-from-top-4 duration-500">
              <p className="text-emerald-100 text-sm font-bold uppercase mb-1">Fecha de Vencimiento Estimada:</p>
        ...
        {/* --- NUEVA GUÍA MAESTRA EN FORMATO TABLA --- */}
        <section className="space-y-6 pt-6">
          ...
          {/* --- SECCIÓN SEO FAQ (LONG-TAIL KEYWORDS) --- */}
          <div className="bg-slate-100 rounded-2xl p-8 border border-slate-200 mt-8">
            <h3 className="text-base font-black text-slate-800 mb-4">¿Por qué calcular el vencimiento con el Batch Code?</h3>
            <p className="text-sm text-slate-600 leading-relaxed mb-4">
              Muchos productos de dermocosmética importados a Chile no traen fecha de caducidad explícita. El <strong>código de lote o Batch Code</strong> es el único identificador oficial del laboratorio que garantiza la vida útil del cosmético, esencial para la seguridad del paciente y el correcto manejo de inventario en el mesón de la farmacia.
            </p>
          </div>

          {/* --- AVISO DE RESPONSABILIDAD LEGAL --- */}
          <div className="bg-amber-50/60 border border-amber-200/70 rounded-2xl p-6 flex gap-4 mt-8">
