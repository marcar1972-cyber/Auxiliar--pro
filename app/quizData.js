...
export const LEVELS = [
  ...
  { 
    id: 3, title: 'Controlados (D.S. 404/405)', desc: 'Estupefacientes y Psicotrópicos.', icon: '🔐', qCount: 25, passingScore: 15,
    questions: [
  ...
  { 
    id: 4, title: 'Simulacro Final (Experto)', desc: 'Matemáticas y Técnica.', icon: '🎓', qCount: 40, passingScore: 24,
    questions: [
