...
export const BLOG_POSTS = [
  {
    ...
    excerpt: 'Si estás pensando en trabajar en farmacia, conoce los requisitos legales y laborales para obtener tu credencial.',
    date: '15 Dic 2025',
    readTime: '5 min',
...
export const FAQS = [
  {
    ...
    a: 'El trámite se realiza en el portal <strong>seremienlinea.minsal.cl</strong> con tu Clave Única.'
  },
  {
