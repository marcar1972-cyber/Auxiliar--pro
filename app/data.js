...
export const LEVELS = [
    ...
    { 
        ...
        questions: [
            ...
            { id: 405, text: 'Validez Receta Cheque:', options: ['30 días', '60 días', '10 días', '1 año'], correctIndex: 0, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 406, text: '¿Puede un auxiliar despachar Receta Cheque solo?', options: ['Sí', 'No, solo el Q.F.', 'Si el Q.F. autoriza', 'En turno de noche'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 407, text: '¿Qué es la "Canela"?', options: ['Especias', 'Incentivo económico prohibido', 'Descuento legal', 'Marca de remedio'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 408, text: 'Medicamento Bioequivalente significa:', options: ['Barato', 'Misma eficacia terapéutica certificada', 'Natural', 'Homeopático'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 409, text: 'Receta de Clonazepam:', options: ['Simple', 'Retenida', 'Cheque', 'Ninguna'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 405.pdf' },
            { id: 410, text: 'Receta de Anfetaminas:', options: ['Simple', 'Retenida', 'Cheque', 'Ninguna'], correctIndex: 2, studyGuide: 'Guía de Estudio_ Decreto 405.pdf' },
            { id: 411, text: 'T° Máxima Sala de Ventas:', options: ['20°C', '25°C', '30°C', '15°C'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 412, text: 'Experiencia requerida para ser Auxiliar:', options: ['6 meses', '1 año', '2 años', 'Nada'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 413, text: 'Libro obligatorio para público:', options: ['Reclamos', 'Ventas', 'Novedades', 'Psicotrópicos'], correctIndex: 0, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 414, text: '¿Dónde se guardan los controlados?', options: ['Estante normal', 'Bajo llave', 'Caja fuerte banco', 'Refrigerador'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 415, text: 'El ISP controla:', options: ['Importación/Fabricación industrial', 'Venta al detalle', 'Recetas', 'Auxiliares'], correctIndex: 0, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 416, text: 'La SEREMI controla:', options: ['Laboratorios', 'Farmacias y venta final', 'Importaciones', 'Aduana'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 417, text: 'Codeína jarabe > 60mg usa receta:', options: ['Simple', 'Retenida', 'Cheque', 'Magistral'], correctIndex: 2, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 418, text: '¿Qué es OTC?', options: ['Venta Directa', 'Controlado', 'Hospitalario', 'Caro'], correctIndex: 0, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 419, text: 'Fraccionamiento debe hacerse en:', options: ['Mesón', 'Área exclusiva y separada', 'Bodega', 'Baño'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 420, text: 'Precio en el envase es:', options: ['Opcional', 'Obligatorio', 'Prohibido', 'Solo en oferta'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 421, text: '¿Quién puede recetar psicotrópicos además de médicos?', options: ['Nadie', 'Dentistas y Veterinarios (en su área)', 'Enfermeras', 'Auxiliares'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 405.pdf' },
            { id: 422, text: 'Lista I de Psicotrópicos (LSD, Éxtasis) es:', options: ['Venta libre', 'Prohibida', 'Receta Cheque', 'Retenida'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 405.pdf' },
            { id: 423, text: '¿Qué se anota en el Libro de Control?', options: ['Precios', 'Entradas, Salidas y Saldos', 'Nombres de empleados', 'Horarios'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 424, text: 'Muestras médicas de estupefacientes:', options: ['Permitidas', 'Prohibidas', 'Solo a veces', 'Regalables'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 425, text: 'Almacén Farmacéutico dirigido por:', options: ['Q.F.', 'Práctico de Farmacia', 'Médico', 'Auxiliar'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 426, text: 'Venta por internet:', options: ['Prohibida', 'Permitida con resolución sanitaria', 'Libre', 'Solo RRSS'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 427, text: 'Petitorio Mínimo:', options: ['Stock opcional', 'Listado obligatorio de medicamentos', 'Lista de precios', 'Inventario'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 428, text: 'Farmacovigilancia reporta:', options: ['Robos', 'Reacciones adversas', 'Ventas bajas', 'Atrasos'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 429, text: 'Receta Retenida se guarda por:', options: ['1 mes', '1 año', '5 años', 'Para siempre'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 430, text: '¿Edad para comprar controlados?', options: ['18 con carnet', '16', '21', 'Cualquiera'], correctIndex: 0, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 431, text: 'Sublingual es:', options: ['Bajo la lengua', 'Tragada', 'Inyectada', 'Rectal'], correctIndex: 0, studyGuide: 'guia_posologia.pdf' },
            { id: 432, text: 'DCI significa:', options: ['Denominación Común Internacional', 'Dosis Común', 'Droga Central', 'Dato Clínico'], correctIndex: 0, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 433, text: '¿Se puede incentivar una marca (Canela)?', options: ['Sí', 'No', 'A veces', 'Si paga bien'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 434, text: 'Color Receta Cheque Farmacia:', options: ['Café', 'Amarillo', 'Rojo', 'Verde'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 435, text: '¿Quién fiscaliza cadena de frío?', options: ['ISP/SEREMI', 'Sernac', 'SII', 'PDI'], correctIndex: 0, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            ...
            // --- SECCIÓN 2: EJERCICIOS MATEMÁTICOS, UI Y POSOLOGÍA ---
            { id: 438, text: 'INSULINA (UI): El frasco dice 100 UI por ml. La receta indica 10 UI. ¿Cuántos ml administra?', options: ['1 ml', '0.1 ml', '0.01 ml', '10 ml'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 439, text: 'VITAMINA D (UI): Cada gota tiene 200 UI. Receta indica 800 UI al día. ¿Cuántas gotas son?', options: ['2 gotas', '4 gotas', '8 gotas', '10 gotas'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 440, text: 'EJERCICIO: Receta dice "Amoxicilina 500mg". Tenemos suspensión de 250mg/5ml. ¿Cuántos ml administra?', options: ['5 ml', '10 ml', '15 ml', '2.5 ml'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 441, text: 'EJERCICIO: Dosis indicada 15 mg. Jarabe concentrado 30mg/ml. ¿Cuántos ml son?', options: ['0.5 ml', '1 ml', '2 ml', '5 ml'], correctIndex: 0, studyGuide: 'guia_posologia.pdf' },
            { id: 442, text: 'CONVERSIÓN: ¿Cuántos miligramos (mg) son 1 gramo?', options: ['100 mg', '1000 mg', '10 mg', '500 mg'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 443, text: 'EJERCICIO: Paciente debe tomar 1 comprimido cada 8 horas por 10 días. ¿Cuántos comprimidos necesita en total?', options: ['20', '24', '30', '40'], correctIndex: 2, studyGuide: 'guia_posologia.pdf' },
            { id: 444, text: 'Si un frasco trae 60ml y la dosis es 5ml al día. ¿Para cuántos días alcanza?', options: ['6 días', '10 días', '12 días', '30 días'], correctIndex: 2, studyGuide: 'guia_posologia.pdf' },
            { id: 445, text: 'Receta: "Paracetamol 1g". Disponible: Comprimidos de 500mg. ¿Cuántos comprimidos da?', options: ['1/2 comprimido', '1 comprimido', '2 comprimidos', '3 comprimidos'], correctIndex: 2, studyGuide: 'guia_posologia.pdf' },
            { id: 446, text: 'CONVERSIÓN: 0.5 gramos es igual a:', options: ['50 mg', '500 mg', '5000 mg', '5 mg'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 447, text: 'Indicación: "1 cucharadita de té". Equivale aprox a:', options: ['2 ml', '5 ml', '10 ml', '15 ml'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 448, text: 'Indicación: "1 cucharada sopera". Equivale aprox a:', options: ['5 ml', '10 ml', '15 ml', '20 ml'], correctIndex: 2, studyGuide: 'guia_posologia.pdf' },
            { id: 449, text: 'EJERCICIO: Dosis 10mg/kg. Paciente pesa 20kg. ¿Dosis total?', options: ['20 mg', '200 mg', '100 mg', '50 mg'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' },
            { id: 450, text: 'Receta: Ibuprofeno 400mg c/8hrs x 3 días. Total mg tratamiento:', options: ['1200 mg', '3600 mg', '2400 mg', '4800 mg'], correctIndex: 1, studyGuide: 'guia_posologia.pdf' }
        ] 
    }
];
