...
// --- NIVELES DEL QUIZ CON ENLACES A PDF (Nombres Largos) ---
export const LEVELS = [
    { 
        id: 1, 
    ...
    { 
        ...
        questions: [
            ...
            { id: 203, text: '¿Qué receta usan los Estupefacientes (Lista I)?', options: ['Simple', 'Retenida', 'Cheque', 'Magistral'], correctIndex: 2, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 204, text: 'Medicamentos con "Estrella Verde" son:', options: ['Venta Directa', 'Psicotrópicos', 'Estupefacientes', 'Bioequivalentes'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 405.pdf' },
            { id: 205, text: '¿Validez de una Receta Cheque?', options: ['60 días', '30 días', '1 año', 'Indefinida'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Decreto 404.pdf' },
            { id: 206, text: '¿Es legal fraccionar medicamentos?', options: ['No', 'Sí, bajo normas y supervisión Q.F.', 'Cualquiera puede', 'Solo antibióticos'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 207, text: '¿Qué libro es OBLIGATORIO para el público?', options: ['Novedades', 'Reclamos y Sugerencias', 'Ventas', 'Asistencia'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 208, text: '¿Está permitida la "Canela" (Incentivos)?', options: ['Sí', 'No, prohibido por Ley de Fármacos', 'A veces', 'Depende'], correctIndex: 1, studyGuide: 'Guía de Estudio_ Ley 20.724 (Ley de Fármacos I).pdf' },
            { id: 209, text: 'Ante una receta ilegible, usted:', options: ['Adivina', 'Pregunta al paciente', 'No despacha y consulta al Q.F.', 'Vende similar'], correctIndex: 2, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 210, text: '¿Tiempo de custodia de Receta Retenida en farmacia?', options: ['1 mes', '6 meses', '1 año', '5 años'], correctIndex: 2, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 211, text: '¿Quién autoriza el funcionamiento de la farmacia?', options: ['Municipalidad', 'ISP', 'SEREMI de Salud', 'SII'], correctIndex: 2, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 212, text: '¿Venta de medicamentos por internet?', options: ['Prohibido', 'Permitido con autorización sanitaria', 'Por WhatsApp', 'Solo vitaminas'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 213, text: 'El "Petitorio Farmacéutico" es:', options: ['Lista de deseos', 'Listado mínimo obligatorio de medicamentos', 'Stock bodega', 'Ofertas'], correctIndex: 1, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 214, text: 'Ante reacción adversa grave:', options: ['Nada', 'Recomendar otro', 'Notificar al Q.F. (Farmacovigilancia)', 'Devolver dinero'], correctIndex: 2, studyGuide: 'Guía de Estudio_Decreto 466.pdf' },
            { id: 215, text: 'El auxiliar de farmacia está facultado para:', options: ['Recetar', 'Cambiar receta', 'Dispensar bajo supervisión', 'Diagnosticar'], correctIndex: 2, studyGuide: 'Guía de Estudio_Decreto 466.pdf' }
        ] 
    },
    { 
        id: 3, 
