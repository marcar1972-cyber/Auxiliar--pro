...
// 1. ARTÍCULOS DEL BLOG (Contenido literal de tus PDFs)
export const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900 border-b pb-2">¿Qué es un Auxiliar de Farmacia?</h2>
      ...
      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900 border-b pb-2">Requisitos para Rendir el Examen de Auxiliar de Farmacia en Chile</h2>
      ...
      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900 border-b pb-2">Requisitos Generales (2026)</h2>
      <div class="space-y-4 my-4">
        ...
        <p><strong>4. Rendir y aprobar el examen:</strong> Este examen evalúa conocimientos como: Farmacología básica, Recetas médicas, Cadena de frío, Fechas de vencimiento, Legislación sanitaria y Buenas prácticas en farmacia.</p>
        <p><strong>5. Obtener la credencial:</strong> Una vez aprobado el examen, la SEREMI entrega la credencial oficial, que te habilita legalmente para trabajar.</p>
      </div>
  ...
  },
  {
    ...
    excerpt: "Entiende las distintas funciones, formación y responsabilidades legales entre ambos roles.",
    date: "17 Dic 2025",
    readTime: "4 min",
    ...
    content: `
      ...
      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900 border-b pb-2">¿Qué es un Auxiliar de Farmacia?</h2>
      <p>El Auxiliar de Farmacia es la persona que apoya al Químico Farmacéutico en: atención de público, dispensación bajo supervisión, reposición, bodegaje y manejo de stock. En Chile, no necesita estudiar en instituto, pero debe tener enseñanza media completa, acreditar 1 año de experiencia y aprobar el examen ante la SEREMI de Salud según el Decreto Supremo N° 466.</p>

      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900 border-b pb-2">¿Qué es un Técnico en Farmacia?</h2>
      <p>El Técnico en Farmacia es un profesional que sí estudia una carrera formal de 2 a 3 años en institutos profesionales o centros de formación técnica. El Técnico no rinde examen en la SEREMI, ya que su título lo habilita directamente para ejercer funciones técnicas más complejas.</p>

      <div class="mt-8 border-t pt-4 text-center italic text-slate-600">
        <p>Ambos son fundamentales para el funcionamiento del sistema de salud farmacéutico en Chile.</p>
      </div>
    `
  },
  {
    ...
    content: `
      <p>Si vas a enfrentar el Examen de Competencia ante la SEREMI de Salud, aquí tienes los 3 pilares fundamentales basados en la normativa oficial (Decretos 466, 404 y 405):</p>

      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900">1. Legislación Farmacéutica</h2>
      <p>La autoridad evalúa si conoces la diferencia entre Receta Cheque (D.S. 404) y Receta Retenida (D.S. 405), la vigencia de 30 días corridos y los libros de control obligatorios.</p>

      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900">2. Almacenamiento y Cadena de Frío</h2>
      <p>Es crítico dominar el rango de temperatura para insulinas y vacunas (2°C a 8°C), el protocolo de corte de luz y el sistema de rotación FEFO (lo primero que vence es lo primero que se vende).</p>

      <h2 class="text-xl font-bold mt-8 mb-4 text-slate-900">3. Matemáticas Farmacéuticas</h2>
      <p>Debes manejar la "Regla de Tres" para calcular dosis y duración de tratamientos. Ejemplo: Amoxicilina 500mg cada 8 horas por 7 días equivale a 21 comprimidos.</p>
    `
  }
];
...
export const LEVELS = [
    { 
        ...
        questions: [
            ...
            { id: 106, text: '¿Qué es un medicamento Bioequivalente?', options: ['Original', 'Mismo efecto comprobado', 'Copia', 'Natural'], correctIndex: 1 },
    ...
    { 
        ...
        questions: [
            ...
            { id: 308, text: 'Anfetaminas receta:', options: ['Simple', 'Retenida', 'Cheque', 'Vale'], correctIndex: 2 },
            { id: 309, text: 'Despacho Receta Cheque:', options: ['Alumno', 'Cajero', 'DT', 'Bodega'], correctIndex: 2 },
            { id: 310, text: 'Muestras Médicas:', options: ['Sí', 'No', 'Amigos', 'Médico'], correctIndex: 1 },
            { id: 311, text: 'Receta falsa:', options: ['Vender', 'Retener y denunciar', 'Devolver', 'Romper'], correctIndex: 1 },
            ...
            { id: 322, text: 'Enmiendas:', options: ['Sí', 'No', 'Firma médico', 'Corrector'], correctIndex: 1 },
            { id: 323, text: 'Receta Retenida:', options: ['Devuelve', 'Bota', 'Custodia farmacia', 'Médico'], correctIndex: 2 },
    ...
    { 
        id: 4, title: 'Simulacro Final', desc: 'Evaluación profesional.', icon: '🎓', qCount: 40, passingScore: 24,
        questions: [
            ...
            { id: 431, text: 'Dentista receta controlados:', options: ['No', 'Sí (Lista IV)', 'Q.F.', 'Morfina'], correctIndex: 1 },
