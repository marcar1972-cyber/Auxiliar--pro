...
export const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <p class="mt-4 italic">Este proceso es fundamental para obtener la credencial oficial de Auxiliar de Farmacia en Chile y poder trabajar legalmente en farmacias comunitarias.</p>
      ...
      <div class="mt-8 border-t pt-4">
        ...
        <p class="mt-2 font-medium">No es imposible, pero sí requiere constancia, práctica real y estudio enfocado.</p>
      </div>
    `
  },
  {
    ...
    content: `
      ...
      <div class="my-6 space-y-2">
        ...
        <p><strong>Técnico en Farmacia:</strong> Estudia 2 a 3 años. Formación académica. No rinde examen. Tiene título profesional. Funciones técnicas más avanzadas.</p>
      </div>
  ...
  },
  {
    ...
    content: `
      ...
      <p class="font-bold bg-blue-50 p-4 rounded-lg">Pregunta típica: "Si llega una receta de Clonazepam (Lista IV) emitida hace 40 días, ¿la puede despachar?" > Respuesta correcta: No. La vigencia legal máxima para recetas de productos controlados es de 30 días corridos.</p>
      ...
      <div class="mt-8 border-t pt-4 space-y-4">
        <h3 class="font-bold text-lg">Consejos Finales para el Día del Examen</h3>
        <p><strong>1. Vocabulario Técnico:</strong> No digas "remedios", di "medicamentos" o "especialidades farmacéuticas". No digas "el doctor de la farmacia", di "Director Técnico".</p>
        <p><strong>2. Seguridad ante todo:</strong> Ante una pregunta con trampa (ej: "¿Vendería antibióticos sin receta si el paciente tiene mucho dolor?"), la respuesta siempre debe priorizar la normativa legal por sobre la venta comercial.</p>
...
// 2. PREGUNTAS FRECUENTES (Restauradas al 100%)
export const FAQS = [
    {
        q: "¿Dónde hago el trámite del examen?",
        a: "Todo se realiza digitalmente en <a href='https://seremienlinea.minsal.cl' target='_blank' class='font-bold text-blue-600 underline'>seremienlinea.minsal.cl</a> ingresando con tu ClaveÚnica."
    },
    {
