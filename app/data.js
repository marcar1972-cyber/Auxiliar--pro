...
// 1. ARTÍCULOS DEL BLOG (Transcripción literal palabra por palabra de los PDFs)
export const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <ol class="list-decimal pl-8 my-4 space-y-4">
        ...
        <li><strong>Haber trabajado en farmacia:</strong> Debes acreditar experiencia práctica en una farmacia, bajo supervisión de un Químico Farmacéutico. <em>Importante: El tiempo exacto y forma de acreditación lo revisa directamente la SEREMI de Salud de tu región.</em></li>
        <li><strong>Rendir y aprobar el examen de Auxiliar de Farmacia:</strong> Este examen evalúa conocimientos como:
      ...
      <div class="mt-8 border-t pt-4 bg-blue-50 p-6 rounded-xl">
        <h3 class="font-bold text-lg mb-2">Conclusión clara</h3>
        <p>Si quieres ser Auxiliar de Farmacia en Chile el 2026, necesitas:</p>
        <p>☑ Cuarto medio</p>
        <p>Mínimo 1 año de experiencia en farmacia</p>
        <p>☑ Aprobar el examen</p>
        <p>Obtener tu credencial SEREMI</p>
        <p class="mt-4 font-medium">No es imposible, pero sí requiere constancia, práctica real y estudio enfocado.</p>
      </div>
    `
  },
  {
    ...
    content: `
      ...
      <ul class="list-none my-4 space-y-1">
      ...
      <p>En Chile, el Auxiliar no necesita estudiar en instituto, pero sí debe: Tener enseñanza media completa, Contar con mínimo 1 año de experiencia en farmacia, Rendir y aprobar el examen ante la SEREMI de Salud, Obtener su credencial oficial de Auxiliar de Farmacia, según el Decreto Supremo N° 466.</p>

      <h2 class="text-xl font-bold mt-6 mb-4">¿Qué es un Técnico en Farmacia?</h2>
      <p>El Técnico en Farmacia es un profesional que sí estudia una carrera formal, generalmente: En institutos profesionales o centros de formación técnica, Durante 2 a 3 años, Con malla académica, prácticas y título técnico.</p>
      <p class="mt-4 font-bold">Sus funciones incluyen:</p>
      <ul class="list-none my-4 space-y-1">
        <li>☑ Apoyar directamente al Químico Farmacéutico</li>
        <li>☑ Preparación de medicamentos</li>
        <li>☑ Control de bodegas</li>
        <li>☑ Gestión de inventarios</li>
        <li>☑ Atención clínica básica</li>
        <li>☑ Apoyo en procesos técnicos más complejos</li>
      </ul>
      <p class="font-bold text-blue-600">El Técnico no rinde examen en la SEREMI, ya que su título lo habilita directamente.</p>

      <h2 class="text-xl font-bold mt-8 mb-4">Diferencias Claves entre Auxiliar y Técnico en Farmacia</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        <div class="bg-slate-50 p-4 rounded-lg">
          <h4 class="font-bold border-b mb-2">Auxiliar de Farmacia</h4>
          <p>No estudia carrera formal</p>
          <p>Aprende trabajando</p>
          <p>Rinde examen SEREMI</p>
          <p>Debe acreditar 1 año de experiencia</p>
          <p>Funciones básicas y apoyo</p>
        </div>
        <div class="bg-blue-50 p-4 rounded-lg">
          <h4 class="font-bold border-b mb-2">Técnico en Farmacia</h4>
          <p>Estudia 2 a 3 años</p>
          <p>Formación académica</p>
          <p>No rinde examen</p>
          <p>Tiene título profesional</p>
          <p>Funciones técnicas más avanzadas</p>
        </div>
      </div>
      ...
      <div class="mt-8 border-t pt-4">
        <h3 class="font-bold text-lg mb-2">Conclusión Clara</h3>
        <p>✓ El Auxiliar de Farmacia se forma en la práctica + examen SEREMI</p>
        <p>✔ El Técnico en Farmacia se forma en instituto + título</p>
        <p>Ambos trabajan bajo supervisión del Químico Farmacéutico</p>
        <p>Ambos pueden desarrollarse profesionalmente en farmacias</p>
      </div>
    `
  },
  {
    ...
    content: `
      <p>Examen de Competencia SEREMI 2025: ¿Qué preguntan realmente?</p>
      <p>Categoría: Certificación y Carrera | Tiempo de lectura: 4 minutos</p>
      ...
      <p>Es normal sentir ansiedad. En internet circulan muchos mitos, pero aquí vamos a analizar, basándonos en la normativa oficial (Decretos 466, 404 y 405), cuáles son los temas que sí o si te van a preguntar.</p>
      ...
      <p>La mayoría de los reprobados caen aquí. La autoridad sanitaria necesita saber si conoces las reglas del juego para no cometer errores legales. Lo que debes dominar:</p>
      <ul class="list-disc pl-8 my-4 space-y-2">
        <li>Diferencia entre Receta Cheque y Receta Retenida: No basta con saber el color de la estrella. Debes saber la vigencia (30 días), los libros de control donde se registran y qué decretos las regulan (Decreto 404 para estupefacientes y 405 para psicotrópicos).</li>
        <li>Roles en la Farmacia: ¿Qué puede hacer el auxiliar y qué es exclusivo del Químico Farmacéutico? (Pista: el auxiliar no puede realizar indicaciones terapéuticas ni "recetar").</li>
        <li>Tipos de Establecimientos: Diferencia legal entre Farmacia, Almacén Farmacéutico y Botiquín.</li>
      </ul>
      <p class="font-bold bg-blue-50 p-4 rounded-lg my-4">Pregunta típica: "Si llega una receta de Clonazepam (Lista IV) emitida hace 40 días, ¿la puede despachar?" > Respuesta correcta: No. La vigencia legal máxima para recetas de productos controlados es de 30 días corridos.</p>

      <h2 class="text-xl font-bold mt-6 mb-4">2. Almacenamiento y Cadena de Frío</h2>
      <p>Este es un tema técnico crítico. Un error aquí pone en riesgo la salud pública, por lo que los evaluadores son muy estrictos. Datos clave que debes memorizar:</p>
      <ul class="list-disc pl-8 my-4 space-y-2">
        <li>Rango de Temperatura: Los refrigeradores para insulinas, vacunas y colirios deben mantenerse estrictamente entre 2°C y 8°C.</li>
        <li>¿Qué hacer si se corta la luz?: Debes conocer el protocolo de quiebre de cadena de frío (no abrir la puerta del refrigerador, registrar la temperatura máxima alcanzada y consultar al Director Técnico antes de vender nada).</li>
        <li>FEFO (First Expired, First Out): El sistema de rotación donde lo primero que vence es lo primero que se vende.</li>
      </ul>

      <h2 class="text-xl font-bold mt-6 mb-4">3. Matemáticas Farmacéuticas (Cálculo de Dosis)</h2>
      <p>No te pedirán cálculo integral, pero sí debes manejar la "Regla de Tres" a la perfección. Ejemplo práctico: Si el médico receta "Amoxicilina 500mg cada 8 horas por 7 días", debes ser capaz de calcular rápidamente cuántos comprimidos o frascos necesita el paciente para el tratamiento completo.</p>
      <p class="mt-4 font-bold text-blue-600">Cálculo: 3 veces al día x 7 días = 21 comprimidos. Si la caja trae 16, debes informar al paciente que necesitará 2 cajas.</p>

      <div class="mt-8 border-t pt-4 space-y-4 bg-slate-50 p-6 rounded-xl">
        <h3 class="font-bold text-lg">Consejos Finales para el Día del Examen</h3>
        <p>1. Vocabulario Técnico: No digas "remedios", di "medicamentos" o "especialidades farmacéuticas". No digas "el doctor de la farmacia", di "Director Técnico".</p>
        <p>2. Seguridad ante todo: Ante una pregunta con trampa (ej: "¿Vendería antibióticos sin receta si el paciente tiene mucho dolor?"), la respuesta siempre debe priorizar la normativa legal por sobre la venta comercial.</p>
        <p>3. Estudia los Decretos: No te quedes solo con los apuntes de tu curso. Lee directamente el Decreto 466; es la fuente de la verdad.</p>
        <p class="mt-4 italic">¿Te estás preparando para el examen? En AuxiliarPro tenemos simuladores basados en preguntas reales para que practiques antes del día clave.</p>
      </div>
    `
  },
  {
    ...
    content: `
      <p>El Decreto Supremo N° 466 es la columna vertebral de nuestra práctica profesional. Establece que las farmacias son centros de salud y define las condiciones sanitarias para su funcionamiento.</p>

      <h2 class="text-xl font-bold mt-6 mb-4">Habilitación del Auxiliar: El Artículo 71</h2>
      <p>El reglamento es estricto: para rendir el examen SEREMI se debe acreditar ser mayor de 18 años, tener enseñanza media completa y un año de práctica en farmacia certificado por el Director Técnico.</p>

      <h2 class="text-xl font-bold mt-6 mb-4">Estándares de Calidad</h2>
      <p>El análisis del reglamento revela estándares críticos que los fiscalizadores de la SEREMI exigen: almacenamiento fuera del suelo, temperatura ambiental máxima de 25°C y cadena de frío estricta.</p>
...
// 2. PREGUNTAS FRECUENTES (Enriquecidas con datos técnicos de los manuales SEREMI)
export const FAQS = [
  {
    q: "¿Dónde hago el trámite del examen?",
    a: "El trámite se encuentra disponible 100% en línea ingresando con <strong>Clave Única</strong> en el portal <a href='https://seremienlinea.minsal.cl' target='_blank' class='text-blue-600 underline font-bold'>seremienlinea.minsal.cl</a>. Debes buscar el botón 'Ir al trámite' para iniciar el proceso."
  },
  {
    q: "¿A quién va dirigido y qué requisitos necesito?",
    a: "Va dirigido a personas naturales que deseen optar a la certificación de competencias y que cumplan con: Certificado de enseñanza media, copia del contrato de trabajo o certificado del empleador que acredite antigüedad, y un certificado de desempeño laboral emitido por un Químico Farmacéutico que acredite al menos 1 año de desempeño efectivo."
  },
  {
    q: "¿Cuál es el costo detallado del trámite?",
    a: "Los costos según el tipo de solicitud son: a. Derecho a Examen $19.100; b. Inscripción en el Registro (incluye primer certificado) $47.600; c. Diploma o Carnet $29.700; d. Certificado adicional $29.700; e. Validación de documentos $19.100."
  },
  {
    q: "¿Cómo es el proceso después de rendir el examen?",
    a: "Una vez rendido y aprobado el examen, queda disponible un segundo trámite por la diferencia de arancel que correspondería a la Resolución de Autorización de Aprobación para el libre ejercicio de la Profesión, la cual incluye la entrega de tu carnet y certificado oficial."
  }
];

// 3. NIVELES DEL QUIZ (Simuladores completos: 90 preguntas)
export const LEVELS = [
    { 
        id: 1, 
    ...
    { 
        ...
        questions: [
            ...
            { id: 205, text: 'La prohibición de la \"Canela\" se refiere a:', options: ['Prohibido vender canela en rama', 'Prohibido dar incentivos económicos por vender marcas específicas', 'Prohibido vender genéricos', 'Prohibido descuentos a 3ra edad'], correctIndex: 1 },
