...
export const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <ol class="list-decimal pl-8 my-4 space-y-2">
        ...
        <li><strong>Rendir y aprobar el examen de Auxiliar de Farmacia:</strong> Evalúa conocimientos como Farmacología básica, Recetas médicas, Cadena de frío, Fechas de vencimiento y Legislación.</li>
      </ol>
    `
  },
  {
    ...
    content: `
      ...
      <h2 class="text-xl font-bold mt-6 mb-4">¿Qué es un Auxiliar de Farmacia?</h2>
      <p>Apoya al Q.F. en atención, dispensación, reposición y stock. En Chile, el Auxiliar no necesita estudiar en instituto, pero debe acreditar 1 año de experiencia para rendir el examen ante la SEREMI según el Decreto Supremo N° 466.</p>
  ...
  },
  {
    ...
    content: `
      <p>Basándonos en la normativa oficial (Decretos 466, 404 y 405), estos son los 3 pilares fundamentales que debes dominar:</p>
      ...
      <p>Los refrigeradores deben mantenerse estrictamente entre 2°C y 8°C. Uso del sistema FEFO.</p>
      <h2 class="text-xl font-bold mt-6 mb-4">3. Matemáticas Farmacéuticas</h2>
      <p>Cálculo de dosis mediante la Regla de Tres.</p>
    `
  },
  {
    id: 4,
    ...
    content: `
      ...
      <h2 class="text-xl font-bold mt-6 mb-4">¿Qué establece el Decreto 466 sobre la Farmacia como Centro de Salud?</h2>
      <p>El Decreto 466 define que las farmacias son centros de salud y establece las condiciones sanitarias mínimas para su funcionamiento. Entre sus puntos más críticos, destaca la obligación de contar con un <strong>Químico Farmacéutico Director Técnico (DT)</strong> presente durante todo el horario de funcionamiento, quien actúa como responsable sanitario ante la autoridad.</p>

      <h2 class="text-xl font-bold mt-6 mb-4">Habilitación del Auxiliar de Farmacia: El Artículo 71</h2>
      <p>Un punto de gran interés es la habilitación profesional para rendir el examen ante la SEREMI de Salud. Si aún no tienes claro si este es tu camino, te recomendamos revisar nuestra guía sobre las <a href="/blog" class="text-blue-600 underline">diferencias entre Auxiliar y Técnico en Farmacia</a>. Según la normativa, el postulante debe cumplir con:</p>
      <ul class="list-disc pl-8 my-4 space-y-2">
        <li>Ser mayor de 18 años y poseer Cédula de Identidad vigente.</li>
        <li>Contar con Licencia de Enseñanza Media completa.</li>
        <li>Acreditar <strong>un año de práctica</strong> en farmacia certificado por el DT del establecimiento.</li>
      </ul>

      <h2 class="text-xl font-bold mt-6 mb-4">Estándares de Almacenamiento y Calidad Exigidos</h2>
      <p>El análisis del reglamento revela estándares críticos que los fiscalizadores de la SEREMI exigen para garantizar la estabilidad de los fármacos:</p>
      <ul class="list-disc pl-8 my-4 space-y-2">
        <li><strong>Almacenamiento:</strong> Los medicamentos jamás deben tocar el suelo; deben ubicarse en estantes o tarimas que permitan la ventilación.</li>
        <li><strong>Control Térmico:</strong> La temperatura ambiental en sala no debe exceder los <strong>25°C</strong>.</li>
        <li><strong>Cadena de Frío:</strong> Medicamentos sensibles deben mantenerse entre <strong>2°C y 8°C</strong>. Puedes consultar más detalles técnicos en el sitio oficial de la <a href="https://seremienlinea.minsal.cl" target="_blank" class="text-blue-600 underline">SEREMI en Línea</a>.</li>
      </ul>
...
export const FAQS = [
    ...
    { q: "¿Costo?", a: "Derecho a examen aprox. $19.100." },
    { q: "¿Reprobación?", a: "Esperar plazo legal y volver a pagar arancel." }
];
...
export const LEVELS = [
    ...
    { id: 3, title: 'Controlados', desc: 'D.S. 404/405.', icon: '🔐', qCount: 25, passingScore: 15, questions: [
        { id: 301, text: 'Estrella Roja:', options: ['Psico', 'Estupe', 'Veneno', 'Frío'], correctIndex: 1 }
    ]},
    { id: 4, title: 'Simulacro Final', desc: 'Experto.', icon: '🎓', qCount: 40, passingScore: 24, questions: [
        { id: 412, text: 'FEFO:', options: ['Entra 1ero', 'Vence 1ero', 'Caro', 'Barato'], correctIndex: 1 }
    ]}
];
