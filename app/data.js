...
El trámite oficial se realiza únicamente a través del portal del Ministerio de Salud en SEREMI en Línea, donde podrás revisar requisitos actualizados, costos y disponibilidad.
...
Todo el proceso se gestiona a través de la SEREMI de Salud de tu región.
Cada región puede variar levemente en exigencias de documentos, pero la base legal es la misma en todo Chile.
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Para solicitar la certificación, debes adjuntar en formato digital los siguientes antecedentes obligatorios: Certificado de enseñanza media completa (o estudios equivalentes calificados por el MINEDUC). Copia del contrato de trabajo o certificado del empleador que acredite antigüedad laboral. Certificado de desempeño laboral emitido y firmado por un Químico Farmacéutico que acredite al menos 1 año de desempeño efectivo. Foto tipo carnet."
  },
  {
    q: "¿Cuál es el costo detallado del trámite?",
    a: "El proceso tiene costos diferenciados según la etapa: Derecho a Examen: $19.100. Inscripción en el Registro (incluye primer certificado): $47.600. Si necesitas documentos adicionales: Diploma o Carnet ($29.700) o Certificados extras ($29.700). Nota: El pago de \"Derecho a Examen\" solo se habilita si cumples con todos los requisitos reglamentarios."
  },
  {
    q: "¿Cómo sé si aprobé y qué pasa después?",
    a: "Tras rendir el examen y si este es aprobado, quedará disponible un segundo trámite para pagar la diferencia de arancel correspondiente a la Resolución de Autorización para el libre ejercicio de la profesión, la cual incluye tu carnet y certificado oficial. En caso de reprobar, la normativa establece que se debe esperar un plazo legal antes de volver a solicitar el examen pagando nuevamente el arancel."
  }
];
