'use client';
import { User, Heart, Lightbulb, ShieldCheck, Cpu } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500 mt-6 max-w-2xl mx-auto font-medium">
            AuxiliaresDeFarmacia.cl nace de una necesidad real, creado por alguien que está en la misma trinchera que tú.
          </p>
        </div>

        {/* Historia Principal - TU TEXTO PERSONALIZADO */}
        <div className="bg-slate-50 rounded-[2.5rem] p-8 md:p-12 border border-slate-200 flex flex-col md:flex-row gap-10 items-center mb-16 shadow-sm">
            <div className="w-24 h-24 md:w-32 md:h-32 bg-white border-4 border-emerald-100 rounded-full flex items-center justify-center flex-shrink-0 text-emerald-500 shadow-md">
                {/* Si tienes foto, puedes poner <img src="/tu-foto.jpg" className="rounded-full" /> */}
                <User size={48} />
            </div>
            <div className="flex-1 text-center md:text-left">
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                    <p>
                        Soy <strong>Auxiliar de Farmacia Trainee</strong> y trabajo actualmente en farmacia. Al igual que tú, me estoy preparando para rendir la prueba de competencia <strong>SEREMI 2026</strong>.
                    </p>
                    <p>
                        Aunque he tenido cursos pagados por mi empleador, me di cuenta de un gran vacío: <strong>no existían ensayos tipo prueba disponibles en la red</strong>. Esa frustración fue mi motor.
                    </p>
                    <p>
                        Decidí no quedarme de brazos cruzados. Con la ayuda de <strong>Inteligencia Artificial (Gemini)</strong>, construí esta plataforma y generé guías de estudio propias. Lanzamos en diciembre de 2025 y ver la afluencia de usuarios me confirma que esto era necesario.
                    </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all group hover:-translate-y-1">
                ...
                <h4 className="font-black text-lg text-slate-900 mb-3">Potenciado por IA</h4>
                <p className="text-sm text-slate-500 leading-relaxed">
                    Esta plataforma fue programada con asistencia de IA avanzada para estructurar el contenido legal complejo de forma simple y didáctica.
                </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all group hover:-translate-y-1">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                    Crear la comunidad de apoyo más grande de Chile. Que la falta de recursos económicos no sea un impedimento para obtener tu credencial.
                </p>
            </div>
            ...
            <div className="bg-emerald-50 p-8 rounded-[2rem] border border-emerald-100 shadow-sm hover:shadow-md transition-all group hover:-translate-y-1">
                ...
                <p className="text-sm text-emerald-800 leading-relaxed font-medium">
                    Sin letra chica. No vendemos tus datos. Este es un aporte personal para devolver la mano a la comunidad y elevar el nivel del rubro.
                </p>
            </div>
        </div>
