...
export default function GuiasIndex() {
  const guias = [
    ...
    {
      // 🟢 NUEVA TARJETA: Crónicos y Antiinfecciosos
      slug: "cronicos-antiinfecciosos",
      title: "Crónicos y Antiinfecciosos",
      desc: "Cardiovascular (HTA), Diabetes, Colesterol y el uso responsable de Antibióticos. Guía clínica avanzada.",
