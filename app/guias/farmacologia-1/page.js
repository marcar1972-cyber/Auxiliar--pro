...
import { ArrowLeft, AlertTriangle, Clock, Zap, Activity, Pill, Thermometer, GraduationCap, PlayCircle, MonitorPlay } from "lucide-react";
  ...
  return (
    <article className="min-h-screen bg-slate-50 font-sans pb-24">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-16 text-slate-700 leading-relaxed">
        ...
        {/* 4. FARMACODINAMIA - TEXTO COMPLETO SOLICITADO */}
        <section>
            <div className="flex items-center gap-3 mb-6">
        ...
        <section className="mt-16 grid md:grid-cols-3 gap-6">
             ...
             <Link href="/quiz" className="group bg-emerald-600 hover:bg-emerald-500 text-white p-8 rounded-2xl transition-all shadow-lg hover:shadow-xl flex flex-col items-center text-center">
                ...
                <p className="text-emerald-100 mb-6">Realiza un Quiz rápido sobre Farmacocinética y Farmacodinamia.</p>
