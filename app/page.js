...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white font-sans text-left">
      ...
      {/* --- TARJETA FORO (SE MANTIENEN RRSS AQUÍ POR CONTEXTO DE COMUNIDAD) --- */}
      ...
      <footer className="w-full bg-slate-50 border-t border-slate-100 py-12 px-4 mt-auto">
        <div className="max-w-md mx-auto text-center space-y-8">
            ...
            <div className="flex justify-center gap-8 mb-4">
                ...
                <a href="https://chat.whatsapp.com/J4VkI8mzTTs9UrzvGqBbdz" target="_blank" className="text-slate-400 hover:text-emerald-500 transition-all hover:scale-110"><MessageCircle size={24} /></a>
            </div>
