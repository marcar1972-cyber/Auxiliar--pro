...
// Configuración de fuentes para eliminar el renderizado tardío (Benchmark)
...
// Icono de WhatsApp con figura de teléfono optimizado para accesibilidad
  ...
  return (
    <main className={`${inter.variable} ${montserrat.variable} flex min-h-screen flex-col bg-white font-sans text-left`}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center max-w-md mx-auto w-full mt-12 mb-10 text-left">
        ...
        {/* Optimización de Imagen: logo.webp con prioridad para LCP */}
        ...
        <div className="w-full space-y-3 text-left">
            {/* Agregado aria-label para benchmark de accesibilidad */}
            <Link href="/quiz" aria-label="Comenzar ahora el examen de práctica" className="block w-full bg-aux-dark text-white font-bold text-lg py-4 rounded-xl shadow-lg shadow-blue-900/10 transition-all text-left">
                COMENZAR AHORA
            </Link>
      ...
      <footer className="w-full bg-slate-50 border-t border-slate-100 py-12 px-4 mt-auto text-left">
        <div className="max-w-md mx-auto text-center space-y-8 text-left">
            <div className="flex justify-center gap-8 mb-4 text-left">
                {/* Agregado aria-label descriptivo para enlaces sociales */}
