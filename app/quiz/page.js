...
// Mapeador para que los niveles muestren el icono correcto según el string en el JS
const iconMap = {
  Scale: <Scale size={32} />,
...
export default function QuizPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 flex items-center justify-center p-6 font-sans">
            <div className="bg-white p-10 rounded-[3rem] shadow-2xl text-center max-w-lg w-full border border-white">
                {savingData && <p className="text-xs text-blue-500 mb-4 animate-pulse font-bold tracking-widest uppercase">Sincronizando progreso...</p>}
                ...
                <h2 className="text-3xl font-black text-slate-800 mb-2 tracking-tight">{passed ? "¡APROBADO!" : "SIGUE PRACTICANDO"}</h2>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button onClick={returnToMenu} className="py-4 text-slate-400 font-bold text-sm">Volver al Menú</button>
                </div>
            </div>
        </div>
    );
  ...
  // --- VISTA: MENÚ PRINCIPAL (RUTA DE CERTIFICACIÓN) ---
  return (
    <main className="min-h-screen bg-slate-50 pb-24 font-sans">
      ...
      <div className="p-6 max-w-xl mx-auto space-y-8 mt-6">
        ...
        <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-5">
             ...
             <div>
                ...
                <p className="text-xs text-slate-400 font-medium italic">Rumbo al examen 2026</p>
             </div>
        </div>
        
        {/* LISTADO DE NIVELES CON ESTÉTICA CIRCULAR */}
        <div className="space-y-4">
          {LEVELS.map((level) => {
              ...
              return (
                  ...
                  >
                      {/* ICONO CIRCULAR (Verde menta en Nivel 4) */}
        ...
        {/* ACCESO A BIBLIOTECA (RESTAURADO) */}
        ...
        <div className="mt-8 p-10 bg-[#0f172a] rounded-[3rem] shadow-2xl relative overflow-hidden text-center border border-white/5">
            ...
            <h3 className="text-2xl font-black text-white mb-3 italic tracking-tight">¿Dudas con la materia?</h3>
            <p className="text-slate-400 text-sm mb-10 leading-relaxed px-4">Únete a nuestro grupo de apoyo para auxiliares y técnicos. Resolvemos dudas en comunidad.</p>
            <button 
      ...
      {/* MODAL DE REGLAS */}
      {showRulesModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-in fade-in zoom-in duration-200 font-sans">
            <div className="bg-white rounded-[3rem] shadow-2xl max-w-sm w-full overflow-hidden border border-white">
                ...
                <div className="p-8 space-y-6">
                    <div className="flex gap-4 items-start">
                        ...
                        <p className="text-sm text-slate-600 leading-snug"><strong>Respeto:</strong> Somos colegas ayudándonos a aprobar. Cero acoso.</p>
                    </div>
                    <div className="flex gap-4 items-start">
