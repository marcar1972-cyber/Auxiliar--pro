...
import { 
  Flame, Clock, CheckCircle2, XCircle, ArrowLeft, Loader2, RefreshCcw, Trophy, Lock, Star
} from "lucide-react";

// 🔥 RUTAS RELATIVAS CORREGIDAS Y VERIFICADAS PARA LA SUBESTRUCTURA DE DOS NIVELES
    ...
    <main className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 max-w-2xl mx-auto w-full min-h-[70vh]">
        <div className="flex justify-center mb-6">
            {/* CORRECCIÓN DE HYDRATION: Solo formateamos el string si existe una pregunta activa en cliente */}
            <div className={`flex items-center gap-2 text-4xl font-black tabular-nums ${isTimeCritical ? 'text-red-500 animate-pulse' : 'text-[#003366]'}`}>
              <Clock size={32} />00:{preguntaActual ? String(timeLeft).padStart(2, '0') : '15'}
            </div>
        </div>
