// app/quizData/pro-eval-1.js

export const proEval1 = {
  id: "pro-eval-1",
  ...
  questions: [
    ...
    {
      question: "Según el Artículo 129 A del Código Sanitario, ¿quién debe dirigir técnicamente una farmacia durante todo su horario de funcionamiento?",
      options: [
    ...
    {
      question: "¿Qué obligación principal introdujo la Ley de Fármacos (Ley 20.724) respecto a la prescripción médica?",
      options: [
    ...
    {
      question: "Un cliente pide ver el reglamento de farmacias para hacer una consulta. Según la normativa, ¿dónde debe estar este material?",
      options: [
    ...
    {
      question: "Si un cliente deja un reclamo oficial en el Libro de Reclamos del establecimiento, ¿cuál es el plazo máximo legal que tiene el Director Técnico para responder?",
      options: [
        "A) 24 horas",
        "B) 3 días",
        "C) 5 días hábiles",
    ...
    {
      question: "En el ámbito legal farmacéutico, ¿qué busca fomentar la información activa sobre medicamentos bioequivalentes?",
      options: [
    ...
    {
      question: "La actividad de una farmacia en Chile se clasifica legalmente como:",
      options: [
    ...
    {
      question: "¿Cuál de los siguientes cuerpos normativos detalla de manera específica la estructura física, el petitorio mínimo y el funcionamiento general que debe tener una farmacia?",
      options: [
